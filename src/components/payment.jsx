...
class payment extends Component {
 ...
 async  confirmorder1() { 
   if(this.state.listData.length!=0){
    ...
    // this.state.listData2.color=this.state.listData[i].color;
    ...
    //  this.state.listData2.invoice_number = 0;
    
    // this.state.listData2.order_status="placed";
    // console.log(this.state.listData2)
    // newstate.push(this.state.listData2)
    // this.state.deliver.push(this.state.listData2[i]);
    ...
    console.log(this.state.invoice_number);
        ...
        this.state.gst+=((this.state.gst)*5)/100;
        ...
        for(var i=0;i<this.state.listData1.length;i++){
            console.log(this.state.listData1[i].provider_id,this.state.deliver[i].provider_id);
     
    await axios.put("http://13.58.92.162:3000/provider/" + this.state.listData1[i].provider_id, this.state.listData1[i]).then(response => {
   ...
   async go(){
        for(var j=0;j<this.state.deliver.length;j++){
             console.log("haii",j);
       await     axios.post("http://13.58.92.162:3000/orders", this.state.deliver[j]).then(response => {
                console.log(response);
