    ...
    componentDidMount() {
       ...
       // console.log(this.state.listData.cust_id);
        if( this.state.listData!=null&&this.state.listData.length!=0) {
            axios.get("http://13.58.92.162:3000/orders/"+this.state.listData[0].cust_id).then(response => {
  ...
  //}
    ...
    Remove(id) {
        ...
        for(var j=0;j<this.state.listData1.length;j++){
            if(this.state.listData1[j].prodId[this.state.listData1[j].index]==id){
        ...
        for(var i=0;i<this.state.listData.length;i++){
            ...
            if(this.state.listData[i].product_id==id){
                                ...
                                <tbody>
                                    ...
                                    {/* {console.log(a.img)} */}
                                        ...
                                        <td className="invert">
                                            ...
                                            <div className="rem">
                                                <div className="close1"> <button className="btn btn-danger btn-sm" onClick={() => this.Remove(a.product_id)}><i className="fa fa-trash"></i></button> </div>
                                            </div>
                        ...
                        <div className="address_form_agile">
                            <h4>Address</h4>
                                ...
                                <div style={{textAlign:"center"}}>
                                    ...
                                    <p>{this.state.listData[0].delivery_address}</p>
                                </div>
