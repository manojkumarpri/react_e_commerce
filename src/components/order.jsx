...
class Order extends Component {
    ...
    del(pid){
      ...
      this.state.combine3.available[this.index][this.state.index2]=this.state.combine3.available[this.index][this.state.index2]+this.state.combine2[0].quantity;
      this.state.combine2[0].quantity=0;
      }
    selectprovider(a, i) {
        console.log("a");
                                ...
                                <div className="container-fliud">
                                    <div className=" row">
                                        ...
                                        <div className="details col-md-6">
                                            ...
                                            <h5 className="sizes" >PREFER YOUR SIZE:
                                            <div className="dropdown">
    <button className="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">{this.state.size}
    <span className="caret"></span></button>
    <ul className="dropdown-menu">
      <li><a  className="btn btn-default dropdown-item"  onClick={(e)=>this.setsize("S",0)}>S</a></li>
      <li><a className="btn btn-default dropdown-item" onClick={(e)=>this.setsize("M",1)}>M</a></li>
      <li><a className=" btn btn-default dropdown-item"  onClick={(e)=>this.setsize("L",2)}>L</a></li>

      <li><a className=" btn btn-default dropdown-item"  onClick={(e)=>this.setsize("XL",3)}>XL</a></li>
    </ul>
  </div>
                                            ...
                                            <div className="dropdown">
    <button className="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">{this.state.color}
    <span className="caret"></span></button>
    <ul className="dropdown-menu">
      <li><a className="btn btn-default dropdown-item" onClick={(e)=>this.setcolor(a.color[0],0)}>{a.color[0]}</a></li>
      <li><a className="btn btn-default dropdown-item"    onClick={(e)=>this.setcolor(a.color[1],1)}>{a.color[1]}</a></li>
      <li><a className="btn btn-default dropdown-item" onClick={(e)=>this.setcolor(a.color[2],2)}>{a.color[2]}</a></li>
      <li><a className="btn btn-default dropdown-item" onClick={(e)=>this.setcolor(a.color[3],3)}>{a.color[3]}</a></li>
    </ul>
  </div>  
       </h5> &nbsp;
                                ...
                                <tbody id="myTable">
                                    {this.state.listData.map((a, index) =>
                                        <tr key={index}>
                                            ...
                                            <td>{a.available[a.prodId.indexOf(this.state.combine2[0].prodId)][this.state.index2]}</td>
